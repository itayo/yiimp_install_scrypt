...
# Current Author: coelacanthus 
# Web:     
#
# Program:
#   Install yiimp on Ubuntu 14.04 running Nginx, MariaDB, and php7.x
# 
# 
################################################################################
output() {
...
' | sudo -E tee /etc/nginx/blockuseragents.rules >/dev/null 2>&1
    ...
    sudo apt-get -y install php7.0-opcache php7.0-fpm php7.0 php7.0-common php7.0-gd php7.0-mysql php7.0-imap php7.0-cli php7.0-cgi php-pear php-auth php7.0-mcrypt mcrypt imagemagick libruby php7.0-curl php7.0-intl php7.0-pspell php7.0-recode php7.0-sqlite3 php7.0-tidy php7.0-xmlrpc php7.0-xsl memcached php-memcache php-imagick php-gettext php7.0-zip php7.0-mbstring
    ...
    sudo apt-get -y install pwgen -y
...
' | sudo -E tee /etc/yiimp/keys.php >/dev/null 2>&1
    ...
    cd yiimp/sql
    # import sql dump
    sudo zcat 2016-04-03-yaamp.sql.gz | sudo mysql -u panel -p${password} yiimpfrontend 
    # oh the humanity!
     sudo mysql -u panel -p${password} yiimpfrontend < 2016-04-24-market_history.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2016-04-27-settings.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2016-05-11-coins.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2016-05-15-benchmarks.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2016-05-23-bookmarks.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2016-06-01-notifications.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2016-06-04-bench_chips.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2016-11-23-coins.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2017-02-05-benchmarks.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2017-03-31-earnings_index.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2017-05-accounts_case_swaptime.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2017-06-payouts_coinid_memo.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2017-09-notifications.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2017-10-bookmarks.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2017-11-segwit.sql
     sudo mysql -u panel -p${password} yiimpfrontend < 2018-01-stratums_ports.sql
